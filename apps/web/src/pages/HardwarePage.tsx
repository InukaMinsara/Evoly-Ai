    ...
    <div className="flex-1 flex flex-col h-full bg-surface">
      <div className="h-16 px-6 border-b border-surface-border flex items-center justify-between bg-surface-card/50">
        <div className="flex items-center gap-3">
          <HardDrive className="w-5 h-5 text-evoly-500" />
          <h1 className="text-lg font-semibold text-slate-200">Hardware Devices</h1>
        </div>
        <button
          onClick={handleScan}
          disabled={isScanning}
          className="flex items-center gap-2 px-3 py-1.5 bg-surface-hover hover:bg-surface-border rounded-lg text-sm text-slate-300 transition-colors"
        >
